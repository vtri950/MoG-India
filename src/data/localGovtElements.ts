...
export function generateLocalGovtAndCivilServiceElements(): GovElement[] {
  ...
  elems.push({
    ...
    category: 'group',
    subtype: 'council',
    description: 'The three-tier system of local self-government in rural India, constitutionalised by the 73rd Amendment Act 1992 (Part IX). PRIs are responsible for planning and implementation of schemes for economic development and social justice across 29 subjects listed in the Eleventh Schedule.',
    parentIds: ['ministry-panchayati-raj'],
  ...
  elems.push({
    ...
    category: 'group',
    subtype: 'council',
    description: 'The system of local self-government in urban India, constitutionalised by the 74th Amendment Act 1992 (Part IXA). Urban Local Bodies are responsible for functions listed in the Twelfth Schedule, including urban planning, regulation of land-use, water supply, public health, and slum improvement. India has approximately 4,657 ULBs.',
    parentIds: ['ministry-housing-urban'],
    secondaryParentIds: ['state-governments'],
